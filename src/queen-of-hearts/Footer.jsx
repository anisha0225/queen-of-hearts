      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between py-4">
          ...
          <div className="w-full md:w-1/4 mb-8">
            <h3 className="text-sm font-semibold mb-4 text-gray-700 text-center md:text-left">Contact Us</h3>
            <div className="space-y-4">
              ...
              <div className="flex justify-center md:justify-start space-x-4 py-8">
          ...
          {/* Address Section */}
          <div className="w-full md:w-1/4 mb-8">
            <h3 className="text-sm font-semibold mb-4 text-gray-700 text-center md:text-left">Address</h3>
            <div className="flex items-center justify-center md:justify-start">
              <img src="/assets/location-pin.png" alt="Phone" className="h-4 w-4 mr-2" />
              <a href="https://www.google.com/search?q=khwaahishdiamonds&sei=NB-QZ-3yK_6jseMP0bP0wAQ" className="text-sm tracking-widest text-gray-600 text-center md:text-left">
