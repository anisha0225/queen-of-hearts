...
const FazzaContainer = () => {
  ...
  return (
    <section ref={fazzaRef} className="text-center w-full h-auto flex-col mt-10 md:mt-10 lg:mt-10 sm:py-1">
        ...
        <div className="bg-neutral-100 rounded-2xl sm:rounded-3xl shadow-md overflow-hidden">
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="w-full lg:w-1/3 flex flex-col justify-center items-center p-6 lg:p-8">
              <h3 className="text-2xl lg:text-5xl text-gray-900 mb-3 lg:mb-4 tracking-widest" id="box">Fazza</h3>
