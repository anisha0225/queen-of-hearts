...
const SwiperContainer = () => {
  ...
  return (
    <section ref={swiperRef} className="py-10 mb-14">
        ...
        <div className="relative">
          ...
          <div className="hidden min-[1026px]:block">
            ...
            >
              ...
              <SwiperSlide className="cursor-grab active:cursor-grabbing">
                <div className="flex flex-col md:flex-row items-center bg-neutral-100 w-[100%] justify-center text-center mx-auto" onClick={() => handleContainerClick(2)}>
                  <div className="w-full md:w-2/3">
              ...
              {[...Array(3)].map((_, index) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all duration-300 ${
                    index === activeIndex ? 'w-7 bg-black' : 'w-2 bg-gray-400'
                  }`}
          ...
          <div className="min-[1026px]:hidden space-y-20">
            ...
            <div className="flex flex-col items-center bg-neutral-100 shadow-md w-[93%] justify-center text-center mx-auto">
              <div className="grid grid-cols-2 md:grid-cols-3 w-full">
                <div className="border-[0.00001rem] border-gray-200 bg-white flex flex-col items-center justify-center p-4">
                ...
                <div className="border-[0.00001rem] border-gray-200 bg-gray-100 flex flex-col items-center justify-center p-4">
                ...
                <div className="col-span-2 md:col-span-1 border-[0.00001rem] border-gray-200 bg-white flex flex-col items-center justify-center p-4">
