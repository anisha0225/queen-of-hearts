    ...
    <footer className="bg-gray-100 py-8">
      <div className="container  mx-auto px-4">
        <div className="flex flex-col sm:flex-row flex-wrap">
          {/* Logo with link */}
          <div className="w-full sm:w-1/2 lg:w-1/4 mb-8 lg:justify-start flex lg:items-center justify-center">
            <div className="flex items-center lg:justify-start text-center justify-center sm:justify-start">
              <img src="/assets/Festara-Logo.svg" alt="Khwaahish Logo" className="px-2 h-10 sm:h-10" />
              <div className="mx-2 h-10 w-px bg-gray-900"></div>
              <Link to="/" className="text-gray-900 text-[4.5vw] sm:text-xl md:text-lg lg:text-xl">QUEEN OF HEARTS</Link>
            </div>
          </div>

          {/* Contact Us Section */}
          <div className="w-full xs:w-1/2 sm:w-1/2 lg:w-1/4 mb-5  px-10">
          ...
          {/* Address Section */}
          <div className="w-full xs:w-1/2 sm:w-1/2 lg:w-1/4 mb-8 px-6 ">
          ...
          {/* Payment Section */}
          <div className="w-full flex flex-col items-center lg:flex-col lg:items-start mt-8">
